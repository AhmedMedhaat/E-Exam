...
<head>
    ...
    <title>Dashboard | E-Exam System</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>E-Exam</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dashboard.php?q=1">Studients</a></li>
                    <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dashboard.php?q=2">Grades</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Quiz Details</b></span><br /><br />
