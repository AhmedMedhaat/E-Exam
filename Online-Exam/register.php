...
<html>
	<head>
        ...
        <style type="text/css">
            body{
                  width: 100%;
                  background: url(image/Exaaam.jpg) ;
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">E-Exam</h4></center><br>
  ...
  <div class="form-group>
    ...
    <select id="college" name="college" placeholder="Select your department" class="form-control input-md" required >
   <option value="" <?php
if (!isset($_GET['college']))
    echo "selected";
?>><c>Select your Department</option>
  <option value="CS" <?php
  if (isset($_GET['college']))
  {
if ($_GET['college'] == "CSE")
